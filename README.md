...
## 方法一：一键安装或更新到最新 ##
 <pre><code>curl --progress-bar -O https://github.com/fyc2780553028-lang/nps-socks5/master/install.sh && chmod 777 install.sh && ./install.sh</code></pre>
或者 
<pre><code>wget --show-progress -q -N --no-check-certificate https://github.com/fyc2780553028-lang/master/install.sh && chmod 777 install.sh && ./install.sh</code></pre>
